from numpy import *
filePath='F:\\ML\\MLdata\\Ch07\\horseColicTraining2.txt'
filePath2='F:\\ML\\MLdata\\Ch07\\horseColicTest2.txt'
def loadSimpData():
    datMat = matrix([[ 1. ,  2.1],
        [ 2. ,  1.1],
        [ 1.3,  1. ],
...
testArr,testLabelArr=loadDataSet(filePath2)
prediction10=adaClassify(testArr, classifierArr)
errorArr=mat(ones((67,1)))
print errorArr[prediction10!=mat(testLabelArr).T].sum()
